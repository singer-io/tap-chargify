...
## 2.1.0
  * Streams that the credentials cannot access (HTTP 403) are now excluded from the catalog during discovery [#58](https://github.com/singer-io/tap-chargify/pull/58)
